...
payroll = sa.Table(
    ...
    sa.Column("overtime_hours",  sa.Numeric(5, 1), nullable=False, server_default=sa.text("0")),
    sa.Column("bonus",          sa.Numeric(12, 2), nullable=False, server_default=sa.text("0")),
    sa.Column("allowance",       sa.Numeric(12, 2), nullable=False, server_default=sa.text("0")),
    ...
    sa.CheckConstraint("overtime_hours >= 0",              name="ck_payroll_overtime_hours_non_negative"),
    sa.CheckConstraint("bonus    >= 0",                   name="ck_payroll_bonus_non_negative"),
    sa.CheckConstraint("allowance >= 0",                   name="ck_payroll_allowance_non_negative"),
